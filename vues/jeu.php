...
?>
    <div class='containerr'>
        <section class="justify-content-center">
            <div class="d-flex justify-content-center" id='delete'>
            </div>
            <section>
                <div class="game_card">
                    ...
                    <div class="game_card_left">
                        ...
                        <div class="game_img" alt="" style="background: url('<?= $instance->getImg(); ?>');
                    ...
                    <div class="game_card_right">
                        ...
                        <div class="smal">
                            ...
                            <div class="roww">
                                <br>
                                <p>Jouable sur
                                    <?php foreach ($instance->getPlateform() as $Plateform) {
                                        echo $Plateform . ", ";
                                    } ?>
                                </p>
                            </div>
                            ...
                            <div class="roww">
                                <br>
                                <p>Catégorie :
                                    <?php foreach ($instance->getCategorie() as $categorie) {
                                        echo $categorie . ", ";
                                    } ?>
                                </p>
                            </div>
                            ...
                            <div class="roww">
                                <br>
                                <p>Langue disponible :
                                    <?php foreach ($instance->getcodeLangue() as $code) {
                                        echo $code . ", ";
                                    } ?>
                                </p>
                            </div>
...
?>
    <div class='alert alert-danger text-center'><a href="../vues/index.php">
            <h4>Erreur de chemin d'accées vous allez etre redirigez d'ici quelques instants ou cliquez ici pour être redigeré</h4>
        </a></div>
    <script>
        window.location.replace("../vues/index.php");
    </script>
<?php
}
